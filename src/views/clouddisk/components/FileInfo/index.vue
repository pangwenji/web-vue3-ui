<template>
  <div class="file-info-content">
    <div class="name">
      ...
      <div v-else class="info-name" @click="renameClick">
    ...
    <div>
      ...
      <ul>
        <li>
          ...
          <span>{{ fileDetail.suffix?.substr(1).toUpperCase() || fileDetail.fileCat }}</span>
        </li>
        <li>
          <span class="info-l">上传者</span>
          <span>{{ fileDetail.user?.nickName || userName }}</span>
        </li>
        <li>
    ...
    <div v-if="fileDetail.fileCat === 'video'">
      ...
      <ul>
        ...
        <li>
          ...
          <span>{{ formatFileSize(fileDetail.metaData?.VideoStreamSet[0]?.Bitrate) }}ps</span>
        </li>
        <li>
    ...
    >
      ...
      <ul>
        ...
        <li>
          <span class="info-l">比特率</span>
          <span
            >{{formatFileSize(fileDetail.metaData?.AudioStreamSet[0]?.Bitrate)}}ps</span
          >
        </li>
        <li>
...
function handleRenameChange() {
  ...
  emits('onRename', {id: fileDetail.value.id, name: rename.value + fileDetail.value.suffix})
}
</script>
