<template>
    ...
    <el-col v-bind="layoutSpan" v-contextmenu:contextmenuRef :style="colStyle" style="margin-bottom: 20px;">
        <div class="file-item-card" :class="{ 'files-folder': type == 'folder' }" :draggable="false" @click.stop="handleGo"
            ...
            <div class="file-item-content" :class="{ check: data['check']}">
                <div class="check-mask" @click.stop="handleRadio" v-if="showCheck"></div>
                ...
                <div class="file-item-cover file-item-bg file-item-audio" v-else-if="type == 'audio'">
                    ...
                    <div class="coding" v-if="data.codingStatus ===1">转码中</div>
                    <div class="coding" v-if="data.codingStatus !==2">转码失败</div>
                    <div class="time">{{secondToDate(data.duration)}}</div>
                </div>
                ...
                <div class="file-item-info">
                    ...
                    <div class="detail">
                        ...
                        <div class="desc">
                            <span v-if="data.type === 1">{{data.createTime.slice(0,10)}}</span>
                            <span v-if="data.type === 2">{{formatSize(data.size)}}</span>
                            ...
                            <!-- <span class="comment" title="评论" v-if="!data.isEditable">
...
const emit = defineEmits(["onChange","onOpenFolder", 'goDetail', 'onChangeRadio']);
